...
logger = get_logger("EXERCISES_ASSERTIONS")  # Создаем логгер с именем "EXERCISES_ASSERTIONS"
...
def assert_get_exercise_response(
        get_exercise_response: ExerciseResponseSchema, create_exercise_response: ExerciseResponseSchema):
    """
    Проверяет, что данные задания при создании и при запросе совпадают

    :param get_exercise_response: ответ API на запрос получения задания
...
def assert_exercise_not_found_response(actual: InternalErrorResponseSchema):
    ...
    # Ожидаемое сообщение об ошибке, если задание не найдено
